...
-- Función para crear citas de forma atómica y segura
...
BEGIN
  ...
  -- 6. Verificar conflictos con otras citas ACTIVAS (usar FOR UPDATE para bloquear filas)
...
-- Dar permisos para que los usuarios puedan ejecutar esta función
GRANT EXECUTE ON FUNCTION public.create_appointment_safely TO authenticated, anon;
